...
DEFAULT_CLASSES = (
    ...
    ("HOUSEHOLD", "Haushalt/Alltag", "base", None),
    ("VEHICLE", "Fahrzeuge", "base", None),
    ("CAR", "Pkw", "fine", "VEHICLE"),
    ("MOTORCYCLE", "Motorrad", "fine", "VEHICLE"),
    ("BICYCLE", "Fahrrad", "fine", "VEHICLE"),
    ("BICYCLE_BRAKE_SQUEAL", "Bremsen / Reifenquietschen", "fine", "VEHICLE"),
    ("FOOTSTEPS", "Schritte / Fußtritte", "fine", "HOUSEHOLD"),
    ("DISHES", "Geschirr", "fine", "HOUSEHOLD"),
    ("SHOPPING_CART", "Einkaufswagen / Rollen und Scheppern", "fine", "HOUSEHOLD"),
    ("DOOR_SLAM", "Wohnungstür zuschlagen", "fine", "HOUSEHOLD"),
